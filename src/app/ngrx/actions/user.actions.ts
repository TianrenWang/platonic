...
export const getMemberships = createAction('Get Memberships', props<{user: User}>());
...
export const updatePhotoSuccesss = createAction('Update User Photo Success', props<{ photoUrl: string}>());
